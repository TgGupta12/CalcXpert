...
function GCDCalculator() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-gradient-to-r from-slate-700 via-slate-800 to-slate-950 rounded-lg shadow-xl">
      <h2 className="text-3xl font-bold text-center text-white mb-4">GCD Calculator</h2>
      <p className="text-center text-purple-200 font-semibold mb-6">
        The Greatest Common Divisor (GCD) is the largest integer that divides two numbers without leaving a remainder.
      </p>
      <div className="mb-4">
